...
export default function EditProject() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!form.title || !form.description) {
            setAlert({ open: true, severity: 'error', message: 'Please fill all required fields.' });
            return;
        }
        setAlert({ open: true, severity: 'success', message: 'Project updated successfully!' });
    };
        ...
        <Container maxWidth="sm" sx={{ mb: 6 }}>
            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    <Grid container spacing={2}> {/* أقل تباعد */}
                        <Grid item xs={12}>
                            <TextField
                                label="Project Title"
                                name="title"
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    '&:hover': {
                                        ...
                                        boxShadow:
                                            '0 0 15px 2px rgba(134, 104, 225, 0.7)',
                                    },
                                }}
                            >
                                Save Changes
