    ...
    return (
        <StyledContainer>
            <Box sx={{ padding: 4, backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
                <Typography variant="h4" textAlign="center" color="#a084e8" mb={4} fontWeight="bold">
                    Contact Us
                </Typography>
                    ...
                    >
                        <ContactCard sx={{ height: "auto" }}>
                            <CardContent>
                                ...
                                <InfoItem icon={EmailIcon} label="Email" value="contact@rafiq.com" />
                                <InfoItem icon={PhoneIcon} label="Phone" value="+20 123 456 7890" />
                                <InfoItem icon={LocationOnIcon} label="Address" value="123 Rafiq St, Cairo, Egypt" />
                            </CardContent>
                        </ContactCard>
